        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <main className="container mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    {/* Next Session - Takes up 1 column */}
                    <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            <div className="p-2 bg-green-50 rounded-lg">
                                <Clock className="text-green-600" size={24} />
                            </div>
                            <span className="text-sm font-medium text-green-600">Next Session</span>
                        </div>
                ...
                {/* Assessment History and Health Metrics Grid */}
                <div className="grid gap-6 grid-cols-1 md:grid-cols-2 mb-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                        <div className="p-6 h-full grid grid-rows-[auto_1fr_auto]">
                            ...
                            <button
                                type="button"
                                className="w-full flex items-center justify-between px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-colors mt-6"
                            >
                    ...
                    <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                        <div className="p-6 h-full grid grid-rows-[auto_1fr_auto]">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="flex items-center justify-between mb-2">
                                        <p className="font-medium text-gray-900">Depression Scale</p>
                                        <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                {/* Mood Tracking Graph - Full Width */}
